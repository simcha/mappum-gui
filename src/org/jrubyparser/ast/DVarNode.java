...
public class DVarNode extends Node implements INameNode {
	...
	// A scoped location of this variable (high 16 bits is how many scopes down
	// and low 16 bits
	...
	/**
	 * How many scopes should we burrow down to until we need to set the block
	 * variable value.
	 * 
	...
	/**
	 * Gets the index within the scope construct that actually holds the eval'd
