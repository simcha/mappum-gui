 ...
 */
public class CallNode extends Node implements INameNode, IArgumentNode,
		BlockAcceptingNode {
	...
	public CallNode(SourcePosition position, Node receiverNode, String name,
			Node argsNode) {
		this(position, receiverNode, name, argsNode, null);
	}

	public CallNode(SourcePosition position, Node receiverNode, String name,
			Node argsNode, Node iterNode) {
		super(position);
	...
	/**
	 * Gets the argsNode representing the method's arguments' value for this
	 * call.
	 * 
	 * @return argsNode
	 */
	...
	/**
	 * Gets the receiverNode. receiverNode is the object on which the method is
	 * being called
	 * 
	 * @return receiverNode
	 */
